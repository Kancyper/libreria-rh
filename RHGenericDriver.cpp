...
{
    Serial.println(F("---- Soy el mensaje de broadcast, acabo de llegar a RHGenericDriver::waitPacketSent"));
    while (_mode == RHModeTx)
        YIELD; // Wait for any previous transmit to finish
    Serial.println(F("---- Soy el mensaje de broadcast, estoy por volver de RHGenericDriver::waitPacketSent"));
    return true;
}
